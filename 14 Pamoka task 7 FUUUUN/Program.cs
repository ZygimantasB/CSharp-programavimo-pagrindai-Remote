...
namespace _14_Pamoka_task_7_FUUUUN
{
    class Program
    {
        ...
        {
            //Console.WriteLine("Irasykite vartotojo varda");
            //prisijungimoVardas = Console.ReadLine();

            //Console.WriteLine("Irasykite vartotojo varda");
            //prisijungimoSlaptazodis = Console.ReadLine();
            ...
            //ar_nori_kartoti = prisijungimoVardas == "Zygimantas" && prisijungimoSlaptazodis == "123456";
